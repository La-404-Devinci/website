...
import LocalSelect from "./buttons/localSelect";
...
const Nav = () => {
  ...
  return (
    <div className="w-full flex justify-between">
      ...
      <div
        className="w-40 h-14 sm:w-56 sm:h-16 rounded-full border border-black flex items-center 
      ...
      >
        ...
        <div
          className="absolute -bottom-full left-1/2 -translate-x-1/2 h-full rounded-[100%]
